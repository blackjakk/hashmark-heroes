...
function renderFrnSeasonRecap() {
  const myId    = franchise.chosenTeamId;
  const myTeam  = getTeam(myId);
  // Defensive: this is now a real router phase (season_recap), so guard the
        ...
        <div class="frn-hero-body">
          <div class="frn-hero-vsbanner">
            <div class="frn-hero-side you" style="--c:${myTeam.primary||'var(--gold)'}">
              ...
              <div class="frn-hero-side-rec">YOU · ${recStr}</div>
            ...
            <div class="frn-hero-side opp" style="--c:${opp.primary||'var(--gray)'}">
              ...
              <div class="frn-hero-side-rec">${opp.city||''} · ${oppStand.w}-${oppStand.l}${oppStand.t?'-'+oppStand.t:''}</div>
