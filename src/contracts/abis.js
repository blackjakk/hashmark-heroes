...
export const LEAGUE_ABI = [
  ...
  "function getSchedule(uint256 season) view returns (tuple(uint256 homeTeamId, uint256 awayTeamId, uint8 week, uint8 homeScore, uint8 awayScore, bool played, bytes32 matchId, bytes32 resultHash)[])",
  "function getWeekGames(uint256 season, uint8 week) view returns (tuple(uint256 homeTeamId, uint256 awayTeamId, uint8 week, uint8 homeScore, uint8 awayScore, bool played, bytes32 matchId, bytes32 resultHash)[])",
  "function playoffSeeds(uint256 season) view returns (uint256[14])",
  "function proofSettlement() view returns (address)",
  "function startSeason()",
  "function advancePhase()",
  "function setProofSettlement(address ps)",
  "function ingestResult(uint256 gameIdx)",
